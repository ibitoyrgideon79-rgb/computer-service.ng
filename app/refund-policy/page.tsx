      ...
      <div className="space-y-5">
        ...
        <Section title="6. Refund Processing Time">
          <div className="flex gap-4 flex-wrap">
            <div className="flex-1 min-w-45 bg-purple-50 border border-purple-100 rounded-lg p-4 text-center">
            ...
            <div className="flex-1 min-w-45 bg-gray-50 border border-gray-100 rounded-lg p-4 text-center">
