...
import {
  ...
  Palette, CreditCard, Monitor, Wrench, ArrowRight, Menu, X,
  GraduationCap, Fingerprint, Wifi, Building2,
} from "lucide-react";
...
const SERVICES = [
  ...
  },
  {
    ...
    iconBg: "bg-orange-50",
    iconColor: "text-orange-500",
    desc: "We handle WAEC, NECO, NABTEB result processing, JAMB registration, and school admissions.",
    categories: ["WAEC Result Processing", "NECO Result Check", "NABTEB Result Check", "JAMB Services", "School Admission", "Result Token Purchase"],
    cta: "/order/details?service=Application+Services",
  },
  {
    name: "NIN & Identity",
    ...
    desc: "NIN corrections, modifications, and reprint services handled professionally.",
    categories: ["NIN DOB Modification", "NIN Name Correction", "NIN Phone Change", "NIN Address Change", "NIN Reprint Slip", "BVN Reprint Slip"],
    cta: "/order/details?service=Application+Services",
  },
  {
    ...
    desc: "Data bundles, airtime, utility bill payments, TV subscriptions, and recharge card printing.",
    categories: ["Internet Data Bundles", "Airtime Purchase", "Utility Bill Payment", "TV Subscription", "Recharge Card Printing"],
    cta: "/order/details?service=Application+Services",
  },
  {
    ...
    desc: "Full CAC registration for business names, limited companies, NGOs, and incorporated trustees.",
    categories: ["Business Name Registration", "Private Limited (Ltd)", "Public Company", "NGO / Incorporated Trustee", "CAC Compliance"],
    cta: "/order/details?service=Application+Services",
  },
];
      ...
      <header className="w-full border-b border-gray-900 sticky top-0 bg-black z-50">
        <div className="container mx-auto px-4 lg:px-8 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 sm:gap-3">
            <div className="relative h-12 w-44 md:h-16 md:w-60">
